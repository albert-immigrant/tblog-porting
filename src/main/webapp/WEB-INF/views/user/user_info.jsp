...
<%--                            <form:input path="email" cssClass="form-control" id="email"/>--%>
                            <form:input path="" cssClass="form-control" id="email"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                     ...
                     <%--       <form:input path="website" cssClass="form-control" id="website"/>--%>
                            <form:input path="" cssClass="form-control" id="website"/>
                        </div>
                    </div>
                ...
                <%--     <form:input path="location" cssClass="form-control" id="location" placeholder="城市名即可，如苏州"/>--%>
                            <form:input path="" cssClass="form-control" id="location" placeholder="城市名即可，如苏州"/>
                        </div>
                    </div>
                  ...
                  <%--   <form:input path="slogan" cssClass="form-control" id="slogan"/>--%>
                            <form:input path="" cssClass="form-control" id="slogan"/>
                        </div>
                    </div>
                    ...
                    <%--     <form:textarea path="selfDesc" cssClass="form-control"></form:textarea>--%>
                            <form:textarea path="" cssClass="form-control" id="selfDesc"></form:textarea>
                        </div>
                    </div>
                    <hr>
               ...
               <%--    <form:input path="socialInfo.githubUsername" cssClass="form-control" id="githubUsername"/>--%>
                            <form:input path="" cssClass="form-control" id="githubUsername"/>
                        </div>
                    </div>
...
<%--                                <form:input path="socialInfo.weiboUsername" cssClass="form-control" id="weiboUsername"/>--%>
                                <form:input path="" cssClass="form-control" id="weiboUsername"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
