...
<div class='container main'>
    <div class='col-md-9'>
        <div class="panel">
            <div class="header">
                <a href="${contextPath}/?tab=all"
                   class='topic-tab <c:if test="${indexVo.tab=='all'}">current-tab</c:if>'>全部</a>
                <c:choose>
                    <c:when test="${catList.size()<=8}">
                        <c:forEach items="${catList}" var="cat">
                            ...
                            <a href="${contextPath}/?tab=${cat.catDir}"
                               class='topic-tab <c:if test="${indexVo.tab==cat.catDir}">current-tab</c:if>'>${cat.catname}</a>
                        </c:forEach>
                    </c:when>
                    <c:otherwise>
                                    ...
                                    <a class="entry-link" href="${contextPath}/article/${topic.id}">
                                        <div class="content-box">
                                            <div class="info-box">
                                                <div class="meta-row">
                                                    <ul class="meta-list">
                                                        ...
                                                        <li class="item username">
                                                            ...
                                                            <a href="${contextPath}/pub/user/<%--${topic.authorid}--%>">aaaaa<%--${topic.authorName}</a>.${topic.friendlyTime}--%>
                                                        </li>
                                                        <li class="item category">
                                                            ...
                                                            <a href="${contextPath}/?tab=${topic.id}">
                                                                <span class="topiclist-tab">${topic.id}</span>
                                                            </a>
                                                        </li>
                                                            <%--
                                                                  <c:if test="${not empty topic.tags}">
                                                                <li class="item tag">
                                                                     <a class="tag" href="${contextPath}/tag/></a>
                                                                 </li>
                                                ...
                                                <div class="title-row">
                                                    <a class="title" href="${contextPath}/article/${topic.id}"
                                                ...
                                                <div class="action-row">
                                                    <div class="action-list">
                                                        ...
                                                        <a class="action comment"
                                                           href="${contextPath}/article/${topic.id}#comment">
                                                            <span class="icon"></span>
                                            ...
                                            <c:if test="${not empty topic.thumbURL}">
                                                <div class="thumb-box"
                                                     style='background-image: url("${contextPath}/upload/getImage/${topic.thumbURL}"); background-size: cover;'></div>
                                            </c:if>
                                        </div>
                                    </a>
                                </div>
